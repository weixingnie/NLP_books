...
processedTxtPath = "assets/native-seattle-processed.txt"
...
txt = txt.replace("natives", "native").replace("indians", "indian").replace("seattles", "seattle").replace("citys", "city")
...
commonwords = {"time", "one", "began", "among", "another", "see", "part", "many", "day", "day", "way", "times",
               ...
               "well", "members", "us", "say", "s", "e", "t", "n", "o", "h", "c", "g", "m"}
...
print('loading model...')
model = Word2Vec.load("assets/native-seattle.w2v")
g = nx.DiGraph()
...
nx.write_gexf(g, "assets/native-seattle.gexf", encoding='utf-8', prettyprint=True, version='1.1draft')
print("finished!")
